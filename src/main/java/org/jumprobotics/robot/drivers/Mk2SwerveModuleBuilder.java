...
public class Mk2SwerveModuleBuilder {
    ...
    public Mk2SwerveModuleBuilder angleMotor(CANSparkMax motor, PidConstants constants, double reduction) {
        ...
        double sensorPositionCoeficient = 2 * Math.PI / 2048.0 * reduction;
    ...
    public Mk2SwerveModuleBuilder angleMotor(TalonFX motor, PidConstants constants, double reduction, int framerate) {
        final double motorEncoderPositionCoefficient = (2.0 * Math.PI) / (reduction * 2048.0);
        TalonFXConfiguration config = new TalonFXConfiguration();
        config.slot0.kP = constants.p;
        config.slot0.kI = constants.i;
        config.slot0.kD = constants.d;

//https://github.com/SwerveDriveSpecialties/swerve-lib/blob/develop/src/main/java/com/swervedrivespecialties/swervelib/ctre/Falcon500SteerControllerFactoryBuilder.java
        ...
        targetAngleConsumer = targetAngle -> {
            ...
            */
            ...
            double adjustedReferenceAngleRadians = targetAngle + currentAngleRadians - currentAngleRadiansMod;
        ...
        initializeAngleCallback = angle -> motor.getSensorCollection().setIntegratedSensorPosition(angle / motorEncoderPositionCoefficient, 50);
